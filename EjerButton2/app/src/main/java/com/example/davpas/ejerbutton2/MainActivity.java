...
/*3.- Añade una fila con tres RadioButton y sus etiquetas Rojo, Verde y Azul. Modifica el color
del TextView de la forma apropiada según la selección del RadioButton*/

package com.example.davpas.ejerbutton2;
